...
{
    public partial class fRpt_BangDiemMon : Form
    {
        int currentIndex = 0;

        public fRpt_BangDiemMon()
        {
            InitializeComponent();
        }

        private void fRpt_BangDiemMon_Load(object sender, EventArgs e)
        {
        ...
        private void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            Xrpt_BangDiemMon rpt = new Xrpt_BangDiemMon(maLop, maMon, int.Parse(lanThi));
